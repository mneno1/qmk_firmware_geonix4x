...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_NO,   KC_SPC,  KC_DEL,  KC_BSPC, KC_ENT,  KC_NO,   KC_RGUI, KC_RALT, KC_RCTL
    ),
    [1] = LAYOUT_tkl_ansi(
    ...
    [2] = LAYOUT_tkl_ansi(
        ...
        KC_NO,   DBG_SW,  QK_BAT,  KC_NO,   KC_LGUI, EE_CLR,  KC_NO,   KC_RGUI, KC_EQL,  RGB_SPD, RGB_VAD, RGB_SPI
    ),
    [3] = LAYOUT_tkl_ansi(
        MD_USB,  MD_BLE1, MD_BLE2, MD_BLE3, MD_24G,  RGB_MOD, TO(1),   TO(0),   KC_LBRC, KC_RBRC, KC_BSLS, RGB_TOG,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
